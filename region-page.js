  ...
  regionRoot.innerHTML = `
    <section class="region-hero">
      <div class="section-inner">
        <div>
          ...
          <p class="section-label">${englishLabel} MIDDLE SCHOOL MATH</p>
          <h1>${region}<br><em>중등 수학과외</em><br>무료체험수업 안내</h1>
          <p class="region-lead">${area} 등 ${region} 중학생의 현재 실력과 목표에 맞춰 내신과 고등 수학 준비를 위한 학습 방향을 설계합니다.</p>
        ...
        <aside class="region-summary" aria-label="수업 요약">
          <h2>무료체험수업 한눈에 보기</h2>
          <dl><div><dt>수업 대상</dt><dd>${region} 중학생</dd></div><div><dt>수업 과목</dt><dd>중등 수학 · 내신 · 선행</dd></div><div><dt>수업 방식</dt><dd>1:1 방문 또는 온라인</dd></div><div><dt>상담 비용</dt><dd>무료</dd></div></dl>
        </aside>
      </div>
    </section>
    <section class="region-benefits section">
      <div class="section-inner">
        ...
        <div class="benefit-grid">
          ...
          <article class="benefit-item"><i data-lucide="chart-no-axes-combined" aria-hidden="true"></i><h3>고등 수학 기초</h3><p>중등 개념을 탄탄히 다지고 학생의 속도에 맞춰 필요한 선행을 준비합니다.</p></article>
        </div>
      </div>
    </section>
    ...
    <section class="contact section" id="contact">
      <div class="section-inner contact-layout">
        ...
        <form class="consult-form" id="consult-form"><div class="field-row"><label>학생 이름<input type="text" name="학생_이름" placeholder="이름" required></label><label>학년<select name="학년" required><option value="">선택해 주세요</option><option>중학교 1학년</option><option>중학교 2학년</option><option>중학교 3학년</option></select></label></div><label>연락처<input type="tel" name="연락처" inputmode="tel" placeholder="010-0000-0000" autocomplete="tel" required></label><label>도로명주소(동호수까지 기재 부탁드립니다!)<input type="text" name="도로명주소" placeholder="예: ${region} ○○로 00, 101동 1001호" autocomplete="street-address" required></label><label>희망사항 및 특이사항<textarea name="희망사항_및_특이사항" rows="3" placeholder="수업 관련 희망사항이나 학생의 특이사항을 적어주세요. (선택)"></textarea></label><label class="consent"><input type="checkbox" name="개인정보_동의" value="동의함" required><span>개인정보 수집 및 상담 활용에 동의합니다.</span></label><button class="submit-button" type="submit">무료체험수업 상담 신청 <i data-lucide="arrow-right" aria-hidden="true"></i></button><p class="form-status" role="status" aria-live="polite"></p></form>
      </div>
    </section>
